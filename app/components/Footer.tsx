...
const linkedinUrl = "https://www.linkedin.com/in/patrik-turcani-b6066a24a/";
const githubUrl = "https://github.com/Patrikturc";
  ...
  return (
    <footer className="bg-gray-800 text-white py-6">
      ...
      <div className="max-w-6xl mx-auto px-4 text-center text-sm mt-4 text-gray-400">
        &copy; {new Date().getFullYear()} Patrik Turcani
      </div>
    </footer>
  );
}
